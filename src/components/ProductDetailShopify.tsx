      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            {/* Review Stats */}
            {(() => {
              const reviewStats = getReviewStats(product.id, isShopifyProduct(product) ? product.handle : undefined);
              return reviewStats.totalReviews > 0 ? (
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <button
                    ...
                    className="text-sm text-[#746cad] hover:underline font-inter"
                  >
                    Read Reviews
                  </button>
                </div>
          ...
          {/* Tabs */}
          <div className="border-b border-[#efeff0]">
            ...
            {activeTab === 'reviews' && (
              <div className="max-w-5xl">
                <ProductReviews
                  ...
                  productHandle={isShopifyProduct(product) ? product.handle : undefined}
                />
              </div>
            )}
          </div>
